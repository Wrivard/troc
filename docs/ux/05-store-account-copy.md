...
Twelve browser combinations (390/768/1440 × EN/FR × light/dark) pass: store CTA within first 844px viewport, keyboard focus destination, About-to-Shop transition, under-$1 max99/sortprice/locale, no horizontal overflow, axe, password helper appropriate to route. Mobile CTA bottom 668px in both languages; mobile store screenshot inspected. Founding EN/FR rendered separately; FR full-page screenshot inspected. Independent revalidation pending. Existing style-guide StoreHero examples automatically share responsive cover refinement.
