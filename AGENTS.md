...
- The user will connect the repository to Vercel. Keep root deployment configuration
  current and document required environment variables. Do not claim a live deployment
  is verified until its actual URL has been tested.
- Keep credentials, local browser profiles and generated screenshots out of Git.
- Do not import a production card catalog before its provider/license is approved.
