...
- **Source:** `src/components/ui/badge-status.tsx`
- **Preview:** `src/preview/demos/badge-status.tsx`
- **Package export:** `@workspace/troc-design-system/components/ui/badge-status`
- **Exports:** Badge, badgeVariants, OrderStatusBadge; types: BadgeProps,
  OrderStatus, OrderStatusBadgeProps
